...
class GoogleLinksController extends Controller {
    ...
    public function actionIndex() {
        $dataProvider = new CActiveDataProvider('GoogleLinks');
    ...
    public function actionAdmin() {
        $model = new GoogleLinks('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['GoogleLinks']))
            $model->attributes = $_GET['GoogleLinks'];
    ...
    public function loadModel($id) {
        $model = GoogleLinks::model()->findByPk($id);
        if ($model === null)
    ...
    protected function performAjaxValidation($model) {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'google-links-form') {
